...
class HomeBloc extends BaseBloc {
  ...
  final _userAvatar = BehaviorSubject<String>();
  final _userAddress = BehaviorSubject<String>();
  final _userOrder = BehaviorSubject<String>();
 ...
 Stream<String> get userAvatar => _userAvatar.stream.transform(vaildateUserAvatar);
 Stream<String> get userAddress => _userAddress.stream.transform(vaildateUserAddress);
 Stream<String> get userOrder => _userOrder.stream.transform(vaildateUserOrder);
 ...
 Stream<bool> get dataValid => Rx.combineLatest8(userName,userEmail, userPhone,userOrder,userAddress,userAvatar,userNote,userOrderType,(userName,userEmail, userPhone,userStore,userAddress,userAvatar,userNote,userOrderType,)=>true);

 String get email => _userEmail.value;
 String get phone => _userPhone.value;
 String get name => _userEmail.value;
 String get  avatar => _userAvatar.value;
String get address => _userAddress.value;
String get order => _userOrder.value;
...
int get ordertype => _userOrderType.value;
 ...
 Function(String) get changeUserAvatar => _userAvatar.sink.add;
 Function(String) get changeUseOrder => _userOrder.sink.add;
...
final vaildateUserAvatar = StreamTransformer<String,String>.fromHandlers(
...
final vaildateUserOrder = StreamTransformer<String,String>.fromHandlers(
...
final vaildateUserOrderType = StreamTransformer<int,int>.fromHandlers(
  handleData:(userOrderType,sink){
    if(userOrderType == null || userOrderType == 0){
