...
class UpcomingProducts extends StatelessWidget {
  final List<UpcomingProduct> products;
  final String title;
  
  const UpcomingProducts({Key key, @required this.products, @required this.title}) : super(key: key);
  ...
  Widget build(BuildContext context) {
      ...
      child:UpcomingProductView(products:products,title:title,))
      );  
  }  
}
